...
@interface NewsPhotoSetController ()<UIScrollViewDelegate>
...
@property(nonatomic,strong) NewsPhotoSet *photoSet;
...
@implementation NewsPhotoSetController
...
- (void)sendRequestWithUrl:(NSString *)url
{
    [[NewsHTTPManager manager]GET:url parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NewsPhotoSet *photoSet = [NewsPhotoSet photoSetWith:responseObject];
...
/** 设置页面文字 */
- (void)setLabelWithModel:(NewsPhotoSet *)photoSet
{
...
/** 设置页面imgView */
- (void)setImageViewWithModel:(NewsPhotoSet *)photoSet
{
